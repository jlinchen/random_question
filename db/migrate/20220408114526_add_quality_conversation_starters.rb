...
class AddQualityConversationStarters < ActiveRecord::Migration[7.0]
  def up
    source = Source.create!(url: 'https://conversationstartersworld.com/250-conversation-starters/')
    questions = [
    ...
    questions.each do |question|
      Question.create!(source:, query: question, would_you: false)
    end
  end
